...
export default function ThemeAwareHybridLessonContent({ lessonData, onComplete, onBack }: ThemeAwareHybridLessonContentProps) {
  ...
  if (isComplete) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <Card className="max-w-md w-full bg-card border-4 border-primary shadow-[12px_12px_0px_rgba(var(--primary-rgb),0.4)] relative">
          ...
          <div className="p-8 text-center">
            ...
            <Button 
              ...
              className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-3 px-8 border-4 border-primary shadow-[8px_8px_0px_rgba(var(--primary-rgb),0.6)] transform hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[12px_12px_0px_rgba(var(--primary-rgb),0.6)] transition-all duration-200 font-sans text-lg"
            >
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="bg-card/80 backdrop-blur-sm border-b-4 border-primary shadow-[0_4px_20px_rgba(var(--primary-rgb),0.3)] sticky top-0 z-40">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              {onBack && (
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="bg-secondary border-3 border-primary text-secondary-foreground hover:bg-primary hover:text-primary-foreground shadow-[4px_4px_0px_rgba(var(--primary-rgb),0.4)] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[6px_6px_0px_rgba(var(--primary-rgb),0.4)] transition-all duration-200 font-sans font-bold"
                >
            ...
            <Badge className="bg-primary text-primary-foreground px-4 py-2 text-sm font-bold border-2 border-primary shadow-[4px_4px_0px_rgba(var(--primary-rgb),0.4)] font-mono">
