        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600 mb-2">K-12</div>
              <p className="text-muted-foreground">Complete curriculum from Kindergarten to Grade 12</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-600 mb-2">GED</div>
            ...
            {features.map((feature, index) => (
              <Card 
                ...
                className={`transition-all duration-300 hover:shadow-lg border-2 ${
                  hoveredFeature === index ? 'border-blue-200 shadow-xl' : 'border-border'
                }`}
      ...
      <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-2xl font-bold">Hagwon</span>
          </div>
