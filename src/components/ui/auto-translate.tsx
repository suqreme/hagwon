...
const translations: Record<string, Record<string, string>> = {
  ...
  es: {
    ...
    'Quizzes Passed': 'Exámenes Aprobados',
    'XP Earned': 'XP Ganado',
    ...
    'Choose Your Game': 'Elige Tu Juego',
    ...
    // Missing Korean translations added to Spanish
    ...
    'We\'ve sent a confirmation link to:': 'Hemos enviado un enlace de confirmación a:',
    'Click the link in your email to activate your account. You may need to check your spam folder.': 'Haz clic en el enlace de tu correo para activar tu cuenta. Puede que necesites revisar tu carpeta de spam.',
    'Back to Sign In': 'Volver al Inicio de Sesión',
    'Country (Optional)': 'País (Opcional)',
    ...
    'Continue as Guest (Coming Soon)': 'Continuar como Invitado (Próximamente)',
    
    // User Menu
    'Administrator': 'Administrador',
    'Classroom Student': 'Estudiante de Aula',
    'Student': 'Estudiante',
    'Admin Panel': 'Panel de Administración',
    'Back to Classroom': 'Volver al Aula',
    'Reset Demo': 'Reiniciar Demo',
    
    // Achievements
    'Loading achievements...': 'Cargando logros...',
    'Achievements & Badges': 'Logros y Medallas',
    'Track your learning progress and earn rewards': 'Rastrea tu progreso de aprendizaje y gana recompensas',
    'Total XP': 'XP Total',
    'Progress to Level': 'Progreso al Nivel',
    'XP needed': 'XP necesario',
    'Badges': 'Medallas',
    'Recent Achievements': 'Logros Recientes',
    'Statistics': 'Estadísticas',
    'Badge Collection': 'Colección de Medallas',
    '✓ Earned': '✓ Obtenido',
    'complete': 'completo',
    'No achievements yet': 'Aún no hay logros',
    'Complete lessons and quizzes to start earning achievements!': '¡Completa lecciones y exámenes para empezar a ganar logros!',
    'Learning Statistics': 'Estadísticas de Aprendizaje',
    'Perfect Scores': 'Puntuaciones Perfectas',
    'Current Streak': 'Racha Actual',
    'Achievement Progress': 'Progreso de Logros',
    'Badges Earned': 'Medallas Obtenidas',
    'Total Achievements': 'Logros Totales',
    
    // Admin Dashboard
    'Access Denied': 'Acceso Denegado',
    'You need administrator privileges to access this page.': 'Necesitas privilegios de administrador para acceder a esta página.',
    'Loading admin dashboard...': 'Cargando panel de administración...',
    'Admin Dashboard': 'Panel de Administración',
    'Hagwon Platform Management': 'Gestión de Plataforma Hagwon',
    'Student View': 'Vista de Estudiante',
    'Refresh Data': 'Actualizar Datos',
    'Total Users': 'Usuarios Totales',
    'Active Users': 'Usuarios Activos',
    'Monthly Revenue': 'Ingresos Mensuales',
    'Subscription Overview': 'Resumen de Suscripciones',
    'Free Users': 'Usuarios Gratuitos',
    'Supporters ($5/mo)': 'Seguidores ($5/mes)',
    'Sponsors ($25/mo)': 'Patrocinadores ($25/mes)',
    'Hardship Approved': 'Dificultad Aprobada',
    'Pending Hardship Requests': 'Solicitudes de Dificultad Pendientes',
    'Approve': 'Aprobar',
    'Deny': 'Denegar',
    ...
    // Dashboard additional
    'Placed at': 'Ubicado en',
    'Your Plan': 'Tu Plan',
    'Daily Lessons': 'Lecciones Diarias',
    'remaining today': 'restantes hoy',
    'Advanced Analytics': 'Análisis Avanzados',
    'Certificates': 'Certificados',
    'Upgrade for Unlimited Access': 'Actualizar para Acceso Ilimitado',
    'Last activity': 'Última actividad',
    
    // Lesson page
    'Generating your lesson...': 'Generando tu lección...',
    'Creating your quiz...': 'Creando tu examen...',
    ...
    'Congratulations! You\'ve successfully completed the lesson on': '¡Felicitaciones! Has completado exitosamente la lección sobre',
    
    // Main page additional
    'Based on your diagnostic test, we\'ve placed you at': 'Basado en tu prueba diagnóstica, te hemos ubicado en',
    'level': 'nivel',
    'You can always adjust this later as you progress through your lessons.': 'Siempre puedes ajustar esto más tarde mientras progresas en tus lecciones.',
    
    // Games page
    'Loading games...': 'Cargando juegos...',
    'Have fun while learning with interactive mini-games': 'Diviértete mientras aprendes con mini-juegos interactivos',
    'View Achievements': 'Ver Logros',
    'Flashcard Challenge': 'Desafío de Tarjetas',
    'Test your knowledge with quick-fire flashcard questions': 'Pon a prueba tu conocimiento con preguntas rápidas de tarjetas',
    'Speed Quiz': 'Examen Rápido',
    'Answer as many questions as possible in 60 seconds': 'Responde tantas preguntas como puedas en 60 segundos',
    'Memory Match': 'Coincidencia de Memoria',
    'Match concepts with their definitions': 'Coincide conceptos con sus definiciones',
    'Word Builder': 'Constructor de Palabras',
    'Build words from given letters to improve vocabulary': 'Construye palabras con letras dadas para mejorar el vocabulario',
    'Time': 'Tiempo',
    'Reward': 'Recompensa',
    'Coming Soon': 'Próximamente',
    'How XP Works': 'Cómo Funciona XP',
    'Earn XP': 'Ganar XP',
    'Complete games and answer questions correctly to earn experience points': 'Completa juegos y responde preguntas correctamente para ganar puntos de experiencia',
    'Level Up': 'Subir de Nivel',
    'Accumulate XP to increase your level and unlock new badges': 'Acumula XP para aumentar tu nivel y desbloquear nuevas medallas',
    'Unlock Badges': 'Desbloquear Medallas',
    'Achieve milestones to earn unique badges and special recognition': 'Alcanza hitos para ganar medallas únicas y reconocimiento especial',
  },
  
  // Portuguese (Brazil) - Major developing country
  pt: {
    'Hagwon Dashboard': 'Painel do Hagwon',
    'Welcome back': 'Bem-vindo de volta',
    'Choose Your Subject': 'Escolha Sua Matéria',
    'Mathematics': 'Matemática',
    'English Language Arts': 'Língua Inglesa',
    'Games': 'Jogos',
    ...
    'Dashboard': 'Painel',
    'Logout': 'Sair',
    'Welcome to Hagwon': 'Bem-vindo ao Hagwon',
    'Ready to Learn!': 'Pronto para Aprender!',
    'Learning Games': 'Jogos Educativos',
  ...
  // French (West/Central Africa, Haiti)
  fr: {
    'Hagwon Dashboard': 'Tableau de Bord Hagwon',
    'Welcome back': 'Bon retour',
    'Choose Your Subject': 'Choisissez Votre Matière',
    'Mathematics': 'Mathématiques',
    'English Language Arts': 'Arts du Langage Anglais',
    'Games': 'Jeux',
    ...
    'Logout': 'Déconnexion',
    'Welcome to Hagwon': 'Bienvenue à Hagwon',
    'Ready to Learn!': 'Prêt à Apprendre !',
    'Learning Games': 'Jeux Éducatifs',
  ...
  // Hindi (India)
  hi: {
    'Hagwon Dashboard': 'हागवॉन डैशबोर्ड',
    'Welcome back': 'वापसी पर स्वागत',
    'Choose Your Subject': 'अपना विषय चुनें',
    'Mathematics': 'गणित',
    'English Language Arts': 'अंग्रेजी भाषा कला',
    'Games': 'खेल',
    ...
    'Dashboard': 'डैशबोर्ड',
    'Logout': 'लॉग आउट',
    'Welcome to Hagwon': 'हागवॉन में आपका स्वागत है',
    'Ready to Learn!': 'सीखने के लिए तैयार!',
    'Learning Games': 'शिक्षा खेल',
  ...
  ar: {
    'Hagwon Dashboard': 'لوحة تحكم هاغوون',
    'Welcome back': 'مرحباً بعودتك',
    'Choose Your Subject': 'اختر مادتك',
    'Mathematics': 'الرياضيات',
    'English Language Arts': 'فنون اللغة الإنجليزية',
    'Games': 'الألعاب',
    'Achievements': 'الإنجازات',
    'Continue Learning': 'متابعة التعلم',
    'Start Learning': 'بدء التعلم',
    ...
    'Logout': 'تسجيل الخروج',
    'Welcome to Hagwon': 'مرحباً بك في هاغوون',
    'Ready to Learn!': 'جاهز للتعلم!',
    'Learning Games': 'ألعاب التعلم',
  ...
  // Swahili (East Africa)
  sw: {
    'Hagwon Dashboard': 'Dashibodi ya Hagwon',
    'Welcome back': 'Karibu tena',
    'Choose Your Subject': 'Chagua Somo Lako',
    'Mathematics': 'Hisabati',
    'English Language Arts': 'Sanaa za Lugha ya Kiingereza',
    'Games': 'Michezo',
    ...
    'Dashboard': 'Dashibodi',
    'Logout': 'Toka',
    'Welcome to Hagwon': 'Karibu Hagwon',
    'Ready to Learn!': 'Tayari Kujifunza!',
    'Learning Games': 'Michezo ya Kujifunza',
    'Start Game': 'Anza Mchezo',
    'Easy': 'Rahisi',
    'Medium': 'Wastani',
    'Hard': 'Ngumu',
